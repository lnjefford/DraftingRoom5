...
internal enum class LibraryCategory(val title: String) {
    ...
    INCOME_GAINS_STATE("Income, gains & state rules"),
    ACA_MEDICARE("ACA & Medicare"),
    SOCIAL_SECURITY("Social Security"),
    DATA_SECURITY_CONSENT("Data security & consent"),
}

internal const val RETIREMENT_LIBRARY_REVIEW_DATE = "September 24, 2026"

internal val RetirementLibraryResources = listOf(
    LibraryResource(
        "irs-rmd",
        LibraryCategory.RETIREMENT_ACCOUNTS,
        "Required minimum distributions",
        "IRS",
        "https://www.irs.gov/retirement-plans/retirement-plan-and-ira-required-minimum-distributions-faqs",
        "When withdrawals begin, which accounts are covered, and how RMDs are calculated.",
    ),
    LibraryResource(
        "irs-early-distributions",
        LibraryCategory.RETIREMENT_ACCOUNTS,
        "Early distributions",
        "IRS",
        "https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-exceptions-to-tax-on-early-distributions",
        "Review the additional tax and the exceptions that may apply before age 59½.",
    ),
    LibraryResource(
        ...
        "Official guidance for IRA withdrawals, beneficiaries, and distribution rules.",
    ),
    LibraryResource(
        "irs-rollovers",
        LibraryCategory.RETIREMENT_ACCOUNTS,
        ...
        "Compare direct transfers, 60-day rollovers, withholding, and account consolidation.",
    ),
    LibraryResource(
        "irs-withholding",
        LibraryCategory.INCOME_GAINS_STATE,
        "Withholding & estimated tax",
        "IRS Publication 505",
        "https://www.irs.gov/forms-pubs/about-publication-505",
        "Plan pay-as-you-go taxes for pensions, gains, and other retirement income.",
    ),
    LibraryResource(
        "irs-capital-gains",
        LibraryCategory.INCOME_GAINS_STATE,
        ...
        "Understand holding periods, gain rates, deductible losses, and carryovers.",
    ),
    LibraryResource(
        ...
        "Wisconsin retirement income",
        "Wisconsin DOR",
        "https://www.revenue.wi.gov/Pages/Individuals/retirement.aspx",
        "State guidance for retirement benefits, estimated payments, and retiree publications.",
    ),
    LibraryResource(
        "irs-hsa",
        LibraryCategory.INCOME_GAINS_STATE,
        ...
        "HSA eligibility, contributions, qualified distributions, and related health plans.",
    ),
    LibraryResource(
        "marketplace-income",
        LibraryCategory.ACA_MEDICARE,
        "Marketplace income",
        "HealthCare.gov",
        "https://www.healthcare.gov/income-and-household-information/",
        "Estimate household income and understand which people and income sources count.",
    ),
    LibraryResource(
        ...
        "See how household size and estimated income affect monthly Marketplace savings.",
    ),
    LibraryResource(
        "medicare-start",
        LibraryCategory.ACA_MEDICARE,
        ...
        "Learn enrollment timing, Medicare parts, coverage choices, and next steps.",
    ),
    LibraryResource(
        "ssa-benefit-estimate",
        LibraryCategory.SOCIAL_SECURITY,
        "Your benefit estimate",
        "Social Security Administration",
        "https://www.ssa.gov/prepare/get-benefits-estimate",
        "View personalized estimates based on your earnings and intended claiming age.",
    ),
    LibraryResource(
        "ssa-claiming-age",
        LibraryCategory.SOCIAL_SECURITY,
        "Claiming-age reductions",
        "Social Security Administration",
        "https://www.ssa.gov/benefits/retirement/planner/agereduction.html",
        "Compare full retirement age with the permanent reductions from claiming earlier.",
    ),
    LibraryResource(
        "cfpb-financial-data-rights",
        LibraryCategory.DATA_SECURITY_CONSENT,
        ...
        "Understand access, sharing, privacy protections, and current rule status.",
    ),
    LibraryResource(
        ...
        "Protect financial accounts with safer software, passwords, authentication, and scam awareness.",
    ),
)
