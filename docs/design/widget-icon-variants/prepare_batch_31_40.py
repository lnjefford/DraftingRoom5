"""Prepare free-silhouette widget art and measured contact sheets for DR5-053."""
...
IDS = [
    "widget_31_sprint_start", "widget_32_rowing", "widget_33_rain_cloud",
    "widget_34_coral", "widget_35_impossible_stair", "widget_36_origami",
    "widget_37_spring", "widget_38_domino", "widget_39_juggling",
    "widget_40_treasure",
]
...
def sheet(icons: list[Image.Image], size: int) -> None:
    ...
    output.save(BATCHES / f"batch-31-40-contact-sheet{suffix}.png")
...
def main() -> None:
    ...
    (BATCHES / "batch-31-40-measurements.json").write_text(
