"""Normalize the ten DR5-051 masters and produce measured widget QA artifacts."""
...
IDS = [
    "widget_11_kettlebell",
    "widget_12_chalk_clap",
    "widget_13_lightning",
    "widget_14_frost",
    "widget_15_alien_abduction",
    "widget_16_lying_down",
    "widget_17_pole_vault",
    "widget_18_slingshot",
    "widget_19_umbrella",
    "widget_20_butterfly",
]
...
def render_sheet(derivatives: list[Image.Image], tile_px: int = 56) -> None:
    ...
    sheet.save(BATCHES / f"batch-11-20-contact-sheet{suffix}.png")
...
def main() -> None:
    ...
    (BATCHES / "batch-11-20-measurements.json").write_text(
