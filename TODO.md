...
4. **Add schedule and custom-routine management**
...
5. **Get tracking backup working with Google**
...
6. **Automate dependency updates and commit builds**
...
8. **Show last synced time per health metric**
...
12. **Add animated in-app branding**
...
14. **Add voice timer announcements**
...
15. **Next feature idea**

    Leave this item open for the next feature to define.

16. **Rename the "running" card to "Distance"**
