...
1. **Move Health Connect settings into the connection card**
...
2. **Fix weight, body-fat, and lean-mass reads — verified on device in v0.2.2**
...
3. **Move connection and update controls into Settings — completed in v0.3.0**
...
6. **Add schedule and custom-routine management**
...
7. **Get tracking backup working with Google**
...
8. **Automate dependency updates and commit builds**
...
14. **Add animated in-app branding**
...
16. **Add voice timer announcements**
