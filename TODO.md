...
3. **Add schedule and custom-routine management**
...
4. **Get tracking backup working with Google**
...
5. **Automate dependency updates and commit builds**
...
7. **Show last synced time per health metric**
...
11. **Add animated in-app branding**
...
13. **Add voice timer announcements**
...
14. **Next feature idea**

    Leave this item open for the next feature to define.

15. **Rename the "running" card to "Distance"**
